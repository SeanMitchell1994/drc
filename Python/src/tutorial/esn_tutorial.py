...
def main():
    ...
    # === Runtime variables ===
    res_size = 8            # Size of the reservoir (nxn matrix)
    learning_rate = 0.3         # learning rate/neural leak/transient rsp
    training_length = 1000      # Length of data we train on
    test_length = 50       # length of data we test on
    #sm_ic = 0.4                 # IC for shift map
    #sm_slope = 2.2                # Slope of shift map

    # === Data variables ===
    #res_fcn = shift_map(sm_slope, res_size, sm_ic)
    #dataset = '../../../datasets/logistic_map_raw.txt'
    LM_Generation(3.75, 10000, 0.7920)
    dataset = '../../../datasets/logistic_map_raw.txt'
