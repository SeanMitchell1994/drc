...
def run_exp(param):
    ...
    while sub_iterates <= max_sub_iterates:
        ...
        new_rc.rc_data  = sm_sweep(2.0, res_size, sm_ic)
...
def main():
    ...
    leg = plt.legend(['DSN MSE','Minimum MSE'],bbox_to_anchor=(1,0.895), loc="center left", numpoints=1)
